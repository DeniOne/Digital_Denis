...
- [x] Настроить structlog
- [x] Создать audit trail таблицу
- [x] Логировать все критические события
- [x] Prometheus metrics endpoint
- [x] Grafana dashboards (опционально)
- [x] Log retention policy настроена
