...
- [ ] Создать таблицу topics в PostgreSQL
- [ ] Создать backend/analytics/topics.py
- [ ] Реализовать TopicExtractor с LLM
- [ ] Загрузить дефолтную иерархию тем
- [ ] Реализовать topic stats API
- [ ] Написать unit-тесты
