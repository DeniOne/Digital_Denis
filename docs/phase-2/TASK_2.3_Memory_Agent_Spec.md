...
- [ ] Реализовать auto_save() в Memory Agent
- [ ] Реализовать extract_candidates() для decisions/insights/facts
- [ ] Реализовать забывание с подтверждением
- [ ] Реализовать агрегацию (v0.2)
