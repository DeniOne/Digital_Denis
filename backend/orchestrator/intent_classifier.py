...
class IntentClassifier:
    ...
    KEYWORDS = {
        "schedule": [
            "напомни", "напоминание", "поставь в расписание", "добавь в календарь",
            "событие", "встреча", "созвон", "задача", "дедлайн",
            "через час", "завтра в", "в понедельник", "в пятницу",
        ...
        "memory": [
            ...
            "моя память", "что было", "когда я говорил",
        ],
        "decision_request": [
