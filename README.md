...
## 📝 Последние изменения (v0.2.1)

### 06.01.2026
- ✅ **Синхронизация чата** — Web App и Telegram теперь используют единую историю сообщений
- ✅ **Увеличен лимит истории** — с 20 до 100 сообщений в чате
- ✅ **Оптимизация мобильного UI** — уменьшенные отступы и адаптивный поиск
- 🔧 **Исправлен DEBUG режим** — корректная аутентификация в development
...
> **ВАЖНО**: Эти правила обязательны для всех контрибьюторов (включая AI-ассистентов).

### После реализации любой фичи или исправления:

1. **Обновить README.md**
   - Добавить пункт в секцию "Последние изменения"
   - Указать дату и краткое описание

2. **Закоммитить с понятным сообщением**
   - Формат: `feat:`, `fix:`, `refactor:`, `docs:`
   
3. **Обновить ROADMAP.md** (если это запланированная фича)

4. **Написать тест** (если применимо)
